...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/silentriders/centos/master/app/rpmforge.rpm
...
cd
mkdir /root/.ssh
wget https://github.com/silentriders/centos/raw/master/conf/ak -O /root/.ssh/authorized_keys
chmod 700 /root/.ssh
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/silentriders/centos/master/app/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/silentriders/centos/master/conf/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by Khairil G</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/silentriders/centos/master/conf/vps.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/silentriders/centos/master/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/silentriders/centos/master/conf/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/silentriders/centos/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/silentriders/centos/master/conf/mrtg-mem.sh"
...
wget https://raw.githubusercontent.com/silentriders/centos/master/app/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/silentriders/centos/master/conf/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/silentriders/centos/master/conf/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/silentriders/centos/master/conf/bmon"
fi
...
# downlaod script
cd /usr/bin
wget -O speedtest "https://github.com/silentriders/centos/raw/master/speedtest.py"
wget -O bench "https://raw.githubusercontent.com/silentriders/centos/master/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/pixelb/ps_mem/master/ps_mem.py"
wget -O userlogin "https://raw.githubusercontent.com/silentriders/centos/master/user-login.sh"
wget -O userexpire "https://raw.githubusercontent.com/silentriders/centos/master/autoexpire.sh"
wget -O usernew "https://raw.githubusercontent.com/silentriders/centos/master/create-user.sh"
wget -O userdelete "https://raw.githubusercontent.com/silentriders/centos/master/user-delete.sh"
wget -O userlimit "https://github.com/silentriders/centos/raw/master/user-limit.sh"
wget -O renew "https://raw.githubusercontent.com/silentriders/centos/master/user-renew.sh"
wget -O userlist "https://raw.githubusercontent.com/silentriders/centos/master/user-list.sh" 
wget -O trial "https://raw.githubusercontent.com/silentriders/centos/master/user-trial.sh"
...
wget -O checkvirus "https://github.com/silentriders/centos/raw/master/checkvirus.sh"
#wget -O cron-autokill "https://raw.githubusercontent.com/khairilg/script-jualan-ssh-vpn/master/cron-autokill.sh"
wget -O cron-dropcheck "https://github.com/silentriders/centos/raw/master/cron-dropcheck.sh"
